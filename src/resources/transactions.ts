...
export class Transactions extends Resource {
	 ...
	 *
	 * Our [crypto SDKs](https://sdk.cauri.dev) provide the functionality needed in most major programming languages. You can read more about it in the send transaction section.
	 *
	 ...
	 *
	 * Cauri currently supports eight different types, but BridgeChains may define more or less if needed for their business purpose.
	 */
