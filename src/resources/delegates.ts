 ...
 *
 * If a Delegate is amongst the top 51 highest voted \(by staked Cauri\), it may run a forging Node, which produces a block once every 6.8 minutes, awarding the Delegate two Cauri + the transaction fees.
 *
 * Genesis Delegates are the initial, virtualized Delegates.
 * They were not registered nor voted in, and in the Cauri `mainnet` has been replaced by actual Delegates a long time ago.
 */
